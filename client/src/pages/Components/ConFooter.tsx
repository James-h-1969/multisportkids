...
export default function ConFooter() {
    ...
    return(
        <div className="d-flex justify-content-center gap-5" style={{fontWeight:"bold", fontSize:mediaQueries.mobile?"2.5vw":"30px", width:"100vw", marginBottom:mediaQueries.mobile?"0px":"50px"}}>
