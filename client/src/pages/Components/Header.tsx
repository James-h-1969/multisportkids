...
const Header: React.FC<HeaderProps> = ({title, description}) => {
  ...
  return (
    <>
          ...
          <div className="" style={{width:mediaQueries.mobile?"90%":"90%", paddingLeft:mediaQueries.mobile?"30px":"90px", fontWeight:"bold"}}>
            <a><span className="heading-description" style={{fontSize:mediaQueries.mobile?"10px":"15px"}}>{description}</span></a>
          </div>
    </>
  )
}
